...
int main(int argc, char* argv[]) {
    ...
    auto cubex = Mesh("assets/models/cube.obj", glm::vec3( 0.0f,  0.0f, 0.0f), glm::vec3(0.0f, 0.5f, 1.0f)); // SimpleCube(glm::vec3( 0.0f,  0.0f, 0.0f), glm::vec3(0.0f, 0.5f, 1.0f));
